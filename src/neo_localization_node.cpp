...
public:
  NeoLocalizationNode(): Node("neo_localization_node")
  {
    ...
    m_sub_map_topic = this->create_subscription<nav_msgs::msg::OccupancyGrid>(m_map_topic, rclcpp::QoS(rclcpp::KeepLast(1)).transient_local().reliable(), std::bind(&NeoLocalizationNode::map_callback, this, _1));
